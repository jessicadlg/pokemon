     ...
     <div class='container'>
         <div class='table-responsive'>
            ...
            <tr>
              ...
              <td class='text-center aling-middle'><img src='recursos/imagenes/<?= $row['imagen']; ?>.png' width='50'></td>
              ...
              <td class='text-center aling-middle'> ".$row['descripcion']." </td>
              <td>
                <div class='d-flex justify-conter-center'>
                <a href='formulario.php?editar= ". $row['id']."' class='btn btn-success text-black'>Editar</a>
                <a href='action.php?borrar=".$row['id']."' class='btn btn-danger text-black ml-1'>Eliminar</a>
                </div>
              </td>";
            echo"</tr>";
             }//<button type='submit' class='btn btn-success text-black '> </button><button type='submit' class='btn btn-danger text-black '>
             ?>
          </tbody>
             </table>
         </div>
...
<div class="container mx-auto">
    <?php
    if($login) echo "<a href='formulario.php' class='btn btn-info btn-block mt-3'>Nuevo Pokemon</a>";
    ?>
</div>
</body>
