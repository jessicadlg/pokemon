...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE listado SET imagen=?,nombre=?,tipo=?,descripcion=? WHERE id=?";
    $stmt = $conexion->prepare($query);
    $stmt->bind_param("ssssi",$act_imagen,$act_nombre,$act_tipo, $act_descripcion,$act_id);
